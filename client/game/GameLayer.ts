...
export abstract class GameLayer extends GameState {
	protected readonly camera: Vector3 = {x: 0, y: 0, z: 3};
	...
	protected abstract drawGame(ctx: CanvasRenderingContext2D, iloader: ImageLoader): void;
